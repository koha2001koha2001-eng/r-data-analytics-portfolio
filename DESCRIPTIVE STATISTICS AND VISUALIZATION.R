...
file_path <- "C:/Users/ADMIN/Desktop/R/Variant_177.csv"
...
write.csv(final_table, "C:/Users/ADMIN/Desktop/R/Итоговая_статистика.csv", 
          row.names = FALSE, fileEncoding = "UTF-8")
cat("✓ Таблица сохранена в CSV: C:/Users/ADMIN/Desktop/R/Итоговая_статистика.csv\n")

# Сохраняем размеры эффекта в файл
sink("C:/Users/ADMIN/Desktop/R/Размеры_эффекта.txt")
